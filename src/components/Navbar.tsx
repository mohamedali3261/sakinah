      ...
      >
        ...
        <div className="hidden lg:flex items-center gap-1.5">
          {[
            ...
            { id: 'tasbih', labelAr: 'السبحة', labelEn: 'Tasbih', icon: <CircleDot className="w-3.5 h-3.5" />, activeClass: 'bg-rose-500/15 text-rose-400 border-rose-500/25' },
            ...
            <div className="relative z-10 space-y-4 font-cairo">
              ...
              <div className="grid grid-cols-2 gap-2">
                {[
                  ...
                  { id: 'tasbih', labelAr: 'السبحة الإلكترونية', labelEn: 'Digital Tasbih', icon: <CircleDot className="w-5 h-5 text-rose-400" /> },
